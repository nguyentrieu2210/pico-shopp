function addItem(name) {
    ...
    input.id = index;
    input.type = "text";
    input.style = "display:inline-block; width:80%; border: 1px solid RGB(47, 165, 255); height:32px;border-radius:3px 0 0 3px; margin:3px 0 3px 3px";
    ...
    del.id = index + "a";
    del.style = "display:inline-block; border-radius: 0 3px 3px 0; height: 33px; margin-top:-2px";
    del.appendChild(i);
